...
export function LandingHeroCarousel({
  ...
  return (
    <div className="w-full relative bg-ink overflow-hidden border-b border-outline dark:border-white/10">
      <Carousel
        setApi={setApi}
      ...
      >
          ...
          {slides.map((slide, index) => {
            ...
            return (
              <CarouselItem key={slide.id} className="p-0 relative w-full">
                <div className="relative w-full min-h-130 sm:min-h-140 md:min-h-150 lg:min-h-160 flex items-center">
                  <Image
                    src={slide.image}
                    alt={slide.title}
                    fill
                  ...
                  <div className="absolute inset-0 bg-linear-to-r from-[#15120D]/95 via-[#15120D]/78 to-[#15120D]/35" />
                  <div className="absolute inset-0 bg-linear-to-t from-[#15120D]/90 via-transparent to-transparent" />
                        ...
                        >
                          ...
                          >
                            <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-black/50 border border-white/15 backdrop-blur-md text-[11px] sm:text-xs md:text-sm text-[#5FD1D8] font-semibold tracking-wide">
                              <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-primary-strong animate-pulse shrink-0" />
                          ...
                          <motion.h1
                            ...
                            className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-[1.14] wrap-break-word"
                          >
                            {slide.title}
                          </motion.h1>
                          ...
                          <motion.div
                            ...
                            className="text-sm sm:text-lg md:text-xl lg:text-2xl font-bold text-[#B39CF0] min-h-10 sm:min-h-[2.2rem] flex items-center leading-snug"
                          >
                            {slide.typewriter ? (
                              <TypewriterText
                                phrases={[
                          ...
                          >
                            <Link
                              ...
                              className="inline-flex items-center justify-center gap-2 sm:gap-3 w-full sm:w-auto h-11 sm:h-12 px-5 sm:px-7 rounded-full bg-primary-strong hover:bg-[#A80D26] text-white text-xs sm:text-sm md:text-base font-bold transition-[transform,background] hover:-translate-y-0.5 cursor-pointer"
                            >
                              <span>
        ...
        <div className="hidden sm:flex absolute bottom-6 sm:bottom-8 right-4 sm:right-8 z-20 items-center gap-2 sm:gap-3">
          <button
            ...
            className="w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-black/50 hover:bg-primary-strong text-white border border-white/15 flex items-center justify-center transition-colors backdrop-blur-md"

...
export const TRIWULAN_KONTEKS: Record<Triwulan, string> = {
  TW1: "Triwulan I (Perencanaan & Evaluasi)",
  TW2: "Triwulan II",
  TW3: "Triwulan III (Monitoring Progres)",
  TW4: "Triwulan IV",
};

export const SIKLUS_TRIWULAN_OPTIONS = [
  { value: "TW1" as Triwulan, label: "Triwulan I (Perencanaan & Evaluasi)", shortLabel: "TW1 — Perencanaan" },
  { value: "TW3" as Triwulan, label: "Triwulan III (Monitoring Progres)", shortLabel: "TW3 — Monitoring" },
];
...
export function triwulanKonteks(tw: Triwulan): string {
  return TRIWULAN_KONTEKS[tw] || TRIWULAN_LABEL[tw];
}
